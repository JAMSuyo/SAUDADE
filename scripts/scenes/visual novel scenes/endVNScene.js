export default class endVNScene extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.dialogues = [
            {
                parts: [
                    { text: "Okay, ", character: 'koreNormal' },
                    { text: " here goes...", character: 'koreNormal', append: true }
                ]
            },
            {
                parts: [
                    { text: "Oh, thank the Weaver, it's openi- ", character: 'koreGrin' },
                    { text: "Huh? ", character: 'koreShock', append: true },
